...
summary: Unified Manager 서버가 인증 서버와 통신하는 것을 방지하려면 인증 서버를 삭제할 수 있습니다.  예를 들어, 관리 서버가 통신하는 인증 서버를 변경하려는 경우 인증 서버를 삭제하고 새 인증 서버를 추가할 수 있습니다. 
---
= 인증 서버 삭제
:allow-uri-read: 
:icons: font
...
. 삭제하려는 인증 서버를 하나 이상 선택한 다음 *삭제*를 클릭합니다.
