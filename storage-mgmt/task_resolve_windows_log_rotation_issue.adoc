...
. Windows에 Unified Manager를 설치하는 경우 Logrotate 버전 0.0.0.18을 설치하세요.  자세한 내용은 다음을 참조하세요.link:https://www.netapp.com/pdf.html?item=/media/78941-tr-4945.pdf["NetApp Manageability SDK 기술 보고서에 대한 보안 강화 가이드"^] .
