...
[role="lead"]
Unified Manager를 업그레이드한 후 Python이나 Microsoft Visual C++ 2013과 같은 타사 제품을 제거할 수 있습니다. 이는 선택 사항입니다.
...
. 프로그램 목록에서 Python을 선택하세요.
. *이 프로그램 제거*를 선택하세요. 3.12를 제외한 모든 Python 버전을 제거하세요.  Python 버전 3.12를 유지하세요.
